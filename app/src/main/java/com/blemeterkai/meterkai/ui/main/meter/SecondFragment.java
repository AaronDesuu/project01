...
import static com.blemeterkai.meterkai.MainActivity.printercsv;
import static com.blemeterkai.meterkai.MainActivity.ratecsv;
...
import com.blemeterkai.meterkai.databinding.FragmentSecondBinding;
...
//        }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // Setup Toolbar
        toolbar = binding.toolbarSecondFragment;
        ...
        if (MainActivity.mSerialID != null) {
            toolbar.setTitle(String.format("SerialID: %s", MainActivity.mSerialID));
        } else {
            toolbar.setTitle("Meter Details");
        }
        mCallback.fragment(this);
        ...
        if (MainActivity.mSerialID == null) {
            NavHostFragment.findNavController(SecondFragment.this)
                    .navigate(R.id.action_meterSecondFragment_to_meterFirstFragment);
        } else {
