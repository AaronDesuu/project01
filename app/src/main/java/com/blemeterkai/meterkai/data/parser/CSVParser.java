package com.blemeterkai.meterkai.data.parser;

import com.blemeterkai.meterkai.utils.row;
...
public class CSVParser {
    ...
    public CSVParser(final File folder) {
        mLabel = null;
        mKey = -1;
        mCsv = null;
        mCol = new ArrayList<String>();
    ...
    public CSVParser(final String csvFile, final File folder) {
        mLabel = null;
        mKey = -1;
        mCol = new ArrayList<String>();
        mRow = new ArrayList<row>();
    ...
    public void Copy(CSVParser from, final String csvFile, final File folder) {
        clear();
        mCol.addAll(from.Columns());
        mRow.addAll(from.Rows());
        mCsv = csvFile;
